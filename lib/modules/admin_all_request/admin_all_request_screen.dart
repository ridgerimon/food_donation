...
class AdminAllRequestScreen extends StatelessWidget {
  const AdminAllRequestScreen({Key? key}) : super(key: key);
                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (context, index) => RequestList(
                        AdminHomeLayoutAppCubit.get(context).allRequest[index],
                        context),
                    separatorBuilder: (context, index) => Divider(),
                    itemCount:
                        AdminHomeLayoutAppCubit.get(context).allRequest.length,
                  ),
                ),
              )
            ],
